...
RUN apt-get update && apt-get install -y curl unzip libonig-dev libxml2-dev libsqlite3-dev \
    && docker-php-ext-install mbstring tokenizer xml dom pdo pdo_sqlite \
